  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authError) {
        ...
        // Verification sent successfully, email confirmation is active
        ...
        <div className="w-full max-w-md relative z-10 animate-fade-in">
          ...
          {verificationSent ? (
            ...
            <div className="text-center space-y-6">
              <div className="w-20 h-20 bg-gradient-to-br from-[#B88A52] to-[#8C6028] rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-[#B88A52]/20 animate-bounce">
                <Mail className="w-10 h-10 text-white" />
              </div>
              <div className="space-y-3">
                <h1 className="font-heading text-4xl font-bold text-white">Verify your email</h1>
                <p className="text-white/50 text-sm max-w-sm mx-auto leading-relaxed">
                  We've sent a verification link to <span className="text-[#e2b784] font-semibold">{email}</span>.
                </p>
              </div>
              
              <div className="p-5 bg-white/[0.03] border border-white/[0.08] rounded-2xl text-left text-sm text-white/40 leading-relaxed max-w-md">
                <p className="font-semibold text-white/60 mb-2">Next Steps:</p>
                <ul className="list-disc pl-5 space-y-1.5">
                  <li>Open your email inbox.</li>
                  <li>Click the verification/confirmation link.</li>
                  <li>After confirmation, you can log in to your dashboard.</li>
                </ul>
